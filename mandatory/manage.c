...
/*   Updated: 2025/05/07 09:32:56 by sidrissi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	while (1337)
// 		if (check_if_all_ate(philo) == 1 || check_if_there_death(philo) == 1)
// 			break ;
// 	return (NULL);
// }
...
int check_if_all_ate(t_philo *philos)
{
	...
	while (i < philos[0].num_philos)
	{
		...
		if (philos[i].meals_eaten >= philos[0].num_time_to_eat)
			all_ate++;
		pthread_mutex_unlock(philos[i].meal_lock);
		i++;
	}
	if (all_ate == philos[0].num_philos)
	{
